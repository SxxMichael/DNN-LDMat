...
# read data
LDMat_train = pd.read_csv("LDMatrix_train.txt", sep=" ")
LDMat_test = pd.read_csv("LDMatrix_test.txt", sep=" ")
res_train = pd.read_csv("response_train.txt", sep=" ")
res_test = pd.read_csv("response_test.txt", sep=" ")
